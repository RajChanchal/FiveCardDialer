...
/// Default is FALSE.
@property (nonatomic) BOOL isInfiniteScrollEnabled;
/// The view controllers that are displayed in the page view controller.
@property (nonatomic, readonly, copy) NSArray<UIViewController *> * _Nullable viewControllers;
/// The view controller that the page view controller is currently at.
@property (nonatomic, readonly, strong) UIViewController * _Nullable currentViewController;
- (void)viewDidLoad;
...
@interface PageboyViewController (SWIFT_EXTENSION(Pageboy)) <UIPageViewControllerDelegate, UIScrollViewDelegate>
...
@interface UIPageViewController (SWIFT_EXTENSION(Pageboy))
@end


@interface UIView (SWIFT_EXTENSION(Pageboy))
@end
...
@interface UIViewController (SWIFT_EXTENSION(Pageboy))
/// The parent PageboyViewController.
/// Available from any direct child view controllers within a PageboyViewController.
@property (nonatomic, readonly, strong) PageboyViewController * _Nullable parentPageboyViewController;
@end
